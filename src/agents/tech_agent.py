...
@lru_cache(maxsize=1)
def get_tech_rag_chain():
    """Retorna el agente RAG completo de Tech como un único Runnable LCEL."""
    answer_chain, retriever = get_tech_chain()
    return build_domain_rag_chain(answer_chain, retriever, domain="tech")
